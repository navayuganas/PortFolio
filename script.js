...
document.querySelectorAll('section, .project-card, .skill-category, .timeline-item, .stat-item').forEach(el => {
...
console.log('%cThis portfolio was built with modern web technologies.', 'font-size: 14px; color: #6b7280;');
